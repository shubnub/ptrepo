...
export PATH=/Users/pete/bin:/Users/pete/work-bin:/opt/local/bin:/opt/local/sbin:/opt/X11/bin:/usr/local/bin:/usr/local/MacGPG2/bin:/usr/bin:/usr/sbin:/bin:/sbin:/opt/local/lib/postgresql96/bin:$HOME/Library/Python/2.7/bin
